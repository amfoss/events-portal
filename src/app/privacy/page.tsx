          ...
          <div className="text-center">
            <div className="text-left max-w-3xl mx-auto">
              ...
              <p className="text-gray-300 leading-relaxed">
                This privacy policy sets out how HRIDESH MATTAKATHARA GOPAKUMAR
                uses and protects any information that you give HRIDESH
                MATTAKATHARA GOPAKUMAR when you use this website.
                <br />
                <br />
                HRIDESH MATTAKATHARA GOPAKUMAR is committed to ensuring that
                ...
                <br />
                <br />
                HRIDESH MATTAKATHARA GOPAKUMAR may change this policy from time
                to time by updating this page. You should check this page from
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                in place suitable electronic and managerial procedures to
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                added and the cookie helps analyse web traffic or lets you know
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                you please write to us at hridesh699@gmail.com.
                <br />
                <br />
